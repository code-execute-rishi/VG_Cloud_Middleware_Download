...
function DisplayCard({
  ...
  return (
    <div
      className={cn(
        "relative flex h-36 w-[22rem] -skew-y-[8deg] select-none flex-col justify-between rounded-xl border-2 bg-black/70 backdrop-blur-sm px-4 py-3 transition-all duration-700 after:absolute after:-right-1 after:top-[-5%] after:h-[110%] after:w-[20rem] after:bg-gradient-to-l after:from-black/70 after:to-blacak/70 after:content-[''] hover:border-white/20 hover:bg-black/60 [&>*]:flex [&>*]:items-center [&>*]:gap-2",
        className
      )}>
      <div>
